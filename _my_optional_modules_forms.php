...
if(current_user_can('manage_options')){
	...
	if(isset($_POST['MOM_UNINSTALL_EVERYTHING'])){
		...
		$option = array('MOM_themetakeover_series_append','MOM_themetakeover_tiledfrontpage','MOM_themetakeover_series_title','MOM_themetakeover_series_key','MOM_themetakeover_series_style','mommaincontrol_comments','MOM_themetakeover_ajaxcomments','MOM_themetakeover_commentlength','MOM_themetakeover_horizontal_galleries','mommaincontrol_prettycanon','mommaincontrol_fixcanon','mommaincontrol_votes_activated','mommaincontrol_protectrss','MOM_themetakeover_extend','MOM_themetakeover_backgroundimage',
		...
		if(isset($_POST['mom_comments_mode_submit']))update_option('mommaincontrol_comments',$_REQUEST['comments']);
