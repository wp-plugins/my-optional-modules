<?php if(!defined('MyOptionalModules')){ die('You can not call this file directly.');}
	...
	echo '<div class="tinythread">Images may only be linked to from these sites</div>
	<hr />
	...
	<div class="tinythread"><span class="tinyspan">(4 blank spaces)quote(4 blank spaces)</span><span class="tinyspan"><span class="quotes"> > quote</span></span></div>
	<div class="tinythread"><span class="tinyspan">----</span><span class="tinyspan">Horizontal divider</span></div>
	...
	<div class="tinythread"><span class="tinyspan">[http://i.imgur.com/*]</span><span class="tinyspan">Embed an image from imgur.</span></div>
	<div class="tinythread"><span class="tinyspan">[http://imgur.com/a/*]</span><span class="tinyspan">Embed an album from imgur.</span></div></div>';
?>