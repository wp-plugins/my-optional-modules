<?php
	...
	function momja_add_options_page() {																
		$obwcountplus_options = add_options_page("MOM: Jump Around", " &not; MOM: Jump Around", "manage_options", "momja", "momja_page_content");
	}	
	...
	function print_jump_around_form() {
		...
		echo "
			<tr valign=\"top\">
				...
				<td><input type=\"text\" name=\"jump_around_0\" value=\"",$default_jump_around_0,"\" /></td>
			</tr>
			<tr valign=\"top\">
				<th scope=\"row\"><label for=\"jump_around_1\">Post permalink class:</label></th>
				<td><input type=\"text\" name=\"jump_around_1\" value=\"",$default_jump_around_1,"\" /></td>
			</tr>
			<tr valign=\"top\">		
				<th scope=\"row\"><label for=\"jump_around_2\">Previous posts link wrapper</label></th>
				<td><input type=\"text\" name=\"jump_around_2\" value=\"",$default_jump_around_2,"\" /></td>
			</tr>
			<tr valign=\"top\">
				<th scope=\"row\"><label for=\"jump_around_3\">Next posts link wrapper</label></th>
				<td><input type=\"text\" name=\"jump_around_3\" value=\"",$default_jump_around_3,"\" /></td>
			</tr>
			<tr valign=\"top\">
