<?php if( !defined( 'MyOptionalModules' ) ) { die( 'You can not call this file directly.' ); }
    ...
    if ( is_admin() ) { 
        ...
        function my_optional_modules_page_content() {
			...
			if ( get_option( 'mommaincontrol_momse' ) == 0 ) { if ( function_exists( 'my_optional_modules_exclude_module' ) || function_exists( 'update_momse_options' ) || function_exists( 'momse_form' ) || function_exists( 'momse_page_content' ) || function_exists( 'momse_filter_home' ) ) { $excludeConflict = 1; } }
