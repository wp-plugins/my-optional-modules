...
== Changelog ==
= .5.3.4 =
* (bugfix) Regular Board | sticky posts should be sorted first and 'stuck' to the top.
* (change) Regular Board | maxreplies added so that you can specify how many replies a thread can receive before no more replies are accepted.  Defaults to 500.
