...
== Changelog ==
= .5.3.8.1 =
* Enable Custom BG Image (Theme Takeover) for current Theme added (to incorporate this functionality if your current theme does not).
* Search form fixed in Navbar
* CSS fixed for bottom navbar
* Extended navbar added, which will show: 9 recent posts,10 most popular tags, word count (for blog and single post), blog title and description, and 25 recent posts with thumbnails in an expansive div.
