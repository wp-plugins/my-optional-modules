...
== Changelog ==
= .5.3.8.3.9 =
* HTML fixed for some elements
* CSS fixed for some elements
* Bugfix: board replies were also being show on thread view, resulting in duplicate view results.
