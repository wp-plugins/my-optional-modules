...
== Changelog ==
= .5.3.9.9 =
* (change) Reviews module no longer has the ability to edit CSS from the options screen.  Instead, you should edit the CSS for the items in your themes style.css.
* (bugfix) Reviews module form handling 
* (change) .5 - 5 in the rating area will result in the display of stars (empty,full, and half) corresponding to the numbers (Font Awesome should be enabled) (.5,1.5,.2.5 for 2 and a half stars, etc)(1,2,3,4... for 1 star, 2 stars, 3 stars, etc)
