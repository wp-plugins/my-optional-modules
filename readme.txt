...
== Changelog ==
= .5.3.8.9.1 =
* Post Votes | CSS changes, downvoting removed, upvote icon changed to heart, top voted output displays vote count but no vote form
* Regular Board | CSS changes to fix a few elements.
* JS | Sisyphus.min.js used in place of sisyphus.js / ftivids.js compressed
* Plugin css compressed
