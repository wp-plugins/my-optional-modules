...
== Changelog ==
= .5.3.8.4 =
* If an image has .skipLazy, it will skip being loaded by Lazy Load.  (This also fixes extended navbar thumbnails if lazy load is also enabled).
* A few CSS fixes for Twenty-Fourteen.
