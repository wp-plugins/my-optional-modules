...
== Changelog ==
* Regular Board / CSS changes and fixes.
* Users can approve of their own threads and replies.
* Bug fixed for user profiles that would not count image-only replies and threads.
* Widgets added for sidebar.
