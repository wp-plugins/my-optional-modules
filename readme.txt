...
== Changelog ==
= .5.3.9.9.5 =
* (bugfix) Regular Board | cutoff not being applied to certain properties
* (bugfix) Shortcodes Google Maps embed in on this day area of the info page
* (update) Font Awesome
