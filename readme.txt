...
== Changelog ==
= .5.3.9.3 =
* (bugfix) Deactivate button for Jump Around now correctly deactivates the module.
* (update) Regular Board / duplicate URLs (on top of duplicate comments) are discarded.
* (update) CSS for Regular Board has been (slightly) altered.
