...
= 6.0.7 =
* [mom_embed] will now embed media using mom_mediaEmbed - supports imgur albums, 
* youtube with ?t parameter, soundcloud, vimeo, gfycat, funnyordie, vine, with 
* oEmbed fallback for WordPress supported embeds not covered.
