...
== Changelog ==
= .5.3.8.8 =
* Regular Board | Reply highlighting via window hash
* Regular Board | User menu (currently only has last 5 threads/replies started by the user for easy navigation to)
* Regular Board | Minor CSS fixes/changes
* Regular Board | Better Akismet implementation.  (Akismet no longer a requirement for Regular Board to function).
